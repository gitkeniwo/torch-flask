...
# disable UserWarning: The parameter 'pretrained' is deprecated since 0.13 and may be removed in the future, please use 'weights' instead.
...
# Load the mapping from class number to human-readable class name
img_class_map = None
